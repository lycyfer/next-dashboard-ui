  ...
  return (
    <div className='flex items-center justify-between p-4'>
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="relative bg-white rounded-full w-7 h-7 items-center flex justify-center cursor-pointer">
        ...
        <div className="flex flex-col">
          <span className="text-xs leading-3 font-medium">Vitalik</span>
